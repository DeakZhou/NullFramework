...
package com.ricky.f.util.lib.toast;
...
public class AppMsg {
     ...
     */
    public static final Style STYLE_ALERT = new Style(LENGTH_LONG, R.color.toast_alert);

    /**
     * Show the text notification for a short period of time with a positive style.
     */
    public static final Style STYLE_CONFIRM = new Style(LENGTH_SHORT, R.color.toast_confirm);

    /**
     * Show the text notification for a short period of time with a neutral style.
     */
    public static final Style STYLE_INFO = new Style(LENGTH_SHORT, R.color.toast_info);
    ...
    public static AppMsg makeText(Activity context, CharSequence text, Style style) {
        return makeText(context, text, style, R.layout.toast_new_bg);
    }
    ...
    public static AppMsg makeText(Activity context, CharSequence text, Style style, float textSize) {
        return makeText(context, text, style, R.layout.toast_new_bg, textSize);
    }
    ...
    public static AppMsg makeText(Activity context, CharSequence text, Style style, float textSize, OnClickListener clickListener) {
        return makeText(context, text, style, R.layout.toast_new_bg, textSize, clickListener);
    }
