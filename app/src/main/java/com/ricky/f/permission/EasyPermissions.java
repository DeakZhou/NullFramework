 ...
 */
package com.ricky.f.permission;
...
public class EasyPermissions {
     ...
     */
    public static void requestPermissions(@NonNull final Object object, @NonNull String rationale, String errInfo,
                                          final int requestCode, @NonNull final String... perms) {
        requestPermissions(object, rationale,errInfo,
                android.R.string.ok,
     ...
     */
    @SuppressLint("NewApi")
    public static void requestPermissions(final Object object, String rationale, String errInfo,
